  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-500 relative overflow-x-hidden selection:bg-primary/20 selection:text-primary">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        {/* Living Aurora Blobs */}
        <div className="absolute -top-[40%] -left-[20%] w-[80%] h-[80%] bg-[radial-gradient(circle,hsl(var(--primary)/0.12)_0%,transparent_60%)] rounded-full blur-[120px] animate-pulse duration-[10s]" />
        <div className="absolute -top-[30%] -right-[10%] w-[60%] h-[70%] bg-[radial-gradient(circle,rgba(99,102,241,0.1)_0%,transparent_50%)] rounded-full blur-[100px] animate-pulse duration-[15s]" />
        <div className="absolute top-[20%] left-[10%] w-[50%] h-[50%] bg-[radial-gradient(circle,rgba(168,85,247,0.06)_0%,transparent_60%)] rounded-full blur-[90px] animate-pulse duration-[12s]" />
        
        {/* Cyberpunk Grid lines */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,hsl(var(--border)/0.15)_1px,transparent_1px),linear-gradient(to_bottom,hsl(var(--border)/0.15)_1px,transparent_1px)] bg-[size:64px_64px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_80%,transparent_100%)] opacity-40" />
        
        {/* Subtle Noise Overlay for premium texture */}
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg viewBox=\'0 0 200 200\' xmlns=\'http://www.w3.org/2000/svg\'%3E%3Cfilter id=\'noiseFilter\'%3E%3CfeTurbulence type=\'fractalNoise\' baseFrequency=\'0.65\' numOctaves=\'3\' stitchTiles=\'stitch\'/%3E%3C/filter%3E%3Crect width=\'100%25\' height=\'100%25\' filter=\'url(%23noiseFilter)\'/%3E%3C/svg%3E')] opacity-[0.015] mix-blend-overlay" />
      </div>
